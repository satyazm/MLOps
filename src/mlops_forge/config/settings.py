"""Configuration settings for MLOps-Forge."""
...
class MLFlowSettings(BaseSettings):
    ...
    EXPERIMENT_NAME: str = Field(default="mlops-forge")
...
class MonitoringSettings(BaseSettings):
    ...
    METRICS_PREFIX: str = Field(default="mlops_forge")
...
class Settings(BaseSettings):
    ...
    DEBUG: bool = Field(default=False)
    PROJECT_NAME: str = Field(default="MLOps-Forge")
    ...
    def get_model_path(self, model_name: Optional[str] = None) -> Path:
        ...
        Args:
            model_name: Name of the model, defaults to MODEL_NAME if None
            
        Returns:
            Path to the model directory
        """
        name = model_name or self.MODEL.MODEL_NAME
        return self.MODEL.MODEL_DIR / name
